...
const BlogDetails = () => {
  ...
  useEffect(() => {
    if (blog?._id) {
      fetch(`https://api.introbangla.com/api/v1/blog/${blog?._id}`)
        .then((res) => res.json())
        .then((data) => {
  ...
  const descriptionClass = blog?.description?.replace(
    /<img/g,
    '<img class="w-full"'
  );
  ...
  return (
    <>
      ...
      <div className="mid-container">
        <div className="lg:flex md:flex mt-32">
          {loading ? (
            <>
            ...
            <div className="lg:w-[70%] md:w-[70%] lg:mb-0 md:mb-0 sm:mb-5 mb-5 lg:border-r-[1px] md:border-r-[1px] lg:pr-8 md:pr-5">
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <div className="ml-6">
                    <p
                      className="antialiased  text-lg cursor-pointer  font-normal flex"
                      onClick={() =>
                        router.push(`/author-blog/${blog?.authorName}`)
                      }
                    >
                      {blog?.authorName}{" "}
              ...
              <div>
                            ...
                            <div className="w-[92%]">
                              <div className="flex items-center gap-2 w-[100%]">
                                <div className="bg-[#f5f9ff] py-2 pl-3 pr-5 rounded border">
                                  <h6 className="font-bold text-sm cursor-pointer">
                                    {comment?.name}
                                  </h6>
                ...
                <div className="mb-10">
                  <form
                    ...
                    className={
                      "lg:space-y-6 md:space-y-5 sm:space-y-6 space-y-4 lg:py-8 md:py-8 sm:py-5 py-5 lg:px-6 md:px-6 px-4 rounded-md bg-[#f5f9ff]"
                    }
                  >
                    ...
                    <div>
                      <div className="grid grid-cols-2 gap-5 mb-5">
                        <div>
                          <input
                            className="py-3 px-5 w-full rounded-md focus:outline-0"
                            type="text"
                            name="name"
                            id="name"
                    ...
                    {loading ? (
                      ...
                      <button
                        disabled={loading}
                        className="btn btn-primary btn-sm ml-3 text-white font-bold"
                        type="submit"
                      >
                        Submit
                      </button>
          ...
          <div className="lg:w-[30%] md:w-[30%] lg:pl-8 md:pl-5  mt-4">
            <h1 className="font-semibold text-xl border-b-[1px] pb-1 mb-5">
              Categories
            </h1>
        ...
        <h1 className="font-semibold text-2xl border-b-[1px] w-52 pb-1 mb-5">
          Related Blogs
        </h1>
