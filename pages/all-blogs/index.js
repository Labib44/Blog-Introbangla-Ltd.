                    ...
                    <div className="mb-3 md:w-[60%] w-full">
                        <div className="input-group relative flex  items-stretch w-full mb-4">
                            ...
                            <input
                                ...
                                type="search" className="form-control  relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search" aria-label="Search" aria-describedby="button-addon2" />
                            ...
                            {/* <button className="btn px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
                             ...
                             <div className="dropdown ">
                                <label tabIndex={0} className=" rounded-l-none btn px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center">Category</label>
                                <ul tabIndex={0} className="dropdown-content menu p-2 w-52 bg-gray-100">
                                   
                                    {
                                        categories?.length > 0 && (
                                            <div
                                                onClick={() => dispatch(toggleFilters('all'))}
                                                className={`border flex justify-center items-center px-4 py-2 mt-2   hover:border-red rounded-3xl cursor-pointer ${filters.includes('all') ? activeClass : null}`}>All</div>
                                        )
                                    }
                                    {
                                        categories?.map((item, index) => (
                                            <div
                                                ...
                                                className={`border flex justify-center items-center px-4 py-2 mt-2  hover:border-red rounded-3xl cursor-pointer ${filters.includes(item) ? activeClass : null}`}>{item}</div>
                                        ))
                                    }
                                </ul>
                            </div>
